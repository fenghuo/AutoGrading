...
int main()
{
    ...
    goto line2;
line1: ;
    m[(int)pow(75, 1)] = (int)pow(5, 1) - (int)pow(((int)pow(m[(int)pow(2, 1)], 1) - (int)pow(6, pow(2, 1))), 1);
    m[(int)pow(13, 1)] = (int)pow(m[(int)pow(2, 1)], 1)*(int)pow(m[(int)pow(0, 1)], 1);
line2: ;
    m[(int)pow(75, 1)] = (int)pow(5, 1) - (int)pow(((int)pow(m[(int)pow(0, 1)], 1) - (int)pow(6, 1)), 1);
    m[(int)pow(13, 1)] = (int)pow(m[(int)pow(2, 1)], 1)*(int)pow(m[(int)pow(0, 1)], 1);
    goto line3;
    printf("%d", (int)pow(5, 1)*(int)pow(5, 1) );
line3: ;
    m[(int)pow(10, 1)] = (int)pow(1334, 1);
    printf("%d", (int)pow(m[(int)pow(0, 1)], 1) );
    printf("%d", (int)pow(m[(int)pow(2, 1)], 1) );
    printf("%d", (int)pow(m[(int)pow(13, 1)], 1) );
    printf("%d", (int)pow(m[(int)pow(10, 1)], 1) );
    printf("%d", (int)pow(m[(int)pow(75, 1)], 1) );
    printf("%d", (int)pow(666444, 1) );
