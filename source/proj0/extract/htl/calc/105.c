...
int main(int argc, char *argv[]){
	...
	m[intPow(56, 1)] = intPow(5, 1) - intPow(m[intPow(4, intPow(3, 1)) * intPow(1, 1) - intPow(2, 1)], 1) - intPow(6, 1);
	my_label2:
	...
	goto my_label4;
	m[intPow(15, 1)] = intPow(2, 1) + intPow(m[intPow(2, 1)], 1);
	m[intPow(56, 1)] = intPow(5, 1) - intPow(m[intPow(3, intPow(4, 1)) * intPow(1, 1) - intPow(2, 1)], 1) - intPow(6, 1);
	my_label1:
	m[intPow(75, 1)] = intPow(5, 1) - intPow((intPow(m[intPow(4, 1)], 1) - intPow(6, 1)), 1);
	m[intPow(68, 1)] = intPow(5, 1) / intPow(2, 1) * intPow(3, 1);
	goto my_label6;
