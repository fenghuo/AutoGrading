...
int main(int argc, char *argv[]){
	...
	m[intPow(56, 1)] = intPow(5, 1) - intPow(m[intPow(4, intPow(1, 1)) * intPow(2, 1) - intPow(2, 1)], 1) - intPow(6, 1);
	my_label11:
	...
	m[intPow(75, 1)] = intPow(5, 1) - intPow((intPow(4, 1) - intPow(6, 1)), 1) / intPow(m[intPow(46, 1)], 1);
