...
int main(int argc, char *argv[]){
	...
	my_label2:
	printf("%d\n", intPow(m[intPow(0, 1)], 1));
	m[intPow(10, 1)] = intPow(5, 1) / intPow(2, 1) * intPow(3, 1);
	m[intPow(44, 1)] = intPow(2, 1) + intPow(2, 1);
	m[intPow(50, 1)] = intPow(5, 1) - intPow((intPow(m[intPow(4, 1)], 1) - intPow(6, 1)), 1);
	m[intPow(70, 1)] = intPow(5, 1) / intPow(2, 1) * intPow(3, 1);
	return 0;
}
